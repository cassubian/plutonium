...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("plutoniumkoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PlutoniumKoin " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"bitcoin.petertodd.org", "testnet-seed.plutoniumkoin.petertodd.org"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PlutoniumKoin is probably already running."), addrBind.ToString().c_str());
        else
